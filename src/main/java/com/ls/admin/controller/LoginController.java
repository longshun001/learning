...
import com.ls.admin.annotation.SysLog;
import com.ls.admin.entity.Menu;
import com.ls.admin.util.Constants;
import com.ls.admin.util.RestResponse;
import com.ls.admin.util.VerifyCodeUtil;
import com.ls.admin.base.BaseController;
import com.ls.admin.base.MySysUser;
...
public class LoginController extends BaseController {
    ...
    public String main(Model model){
        ...
        Set<com.ls.admin.entity.Menu> menus = user.getMenus();
        java.util.List<com.ls.admin.entity.Menu> showMenus = Lists.newArrayList();
...
class MenuComparator implements Comparator<com.ls.admin.entity.Menu>{

    @Override
    public int compare(com.ls.admin.entity.Menu o1, com.ls.admin.entity.Menu o2) {
